...
class WindowsWrapper(torch.nn.Module):
    ...
    equally sized windows (the bottom and right windows might be a little bit smaller), with sizes that are
    multiples of the patch size (as the input should be).
